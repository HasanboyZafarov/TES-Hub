      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-10">
        <div className="w-full lg:w-[70%]">
          ...
          <PostList
            ...
            isLoading={isLoading}
            error={error}
            emptyMessage={t("community.region.empty")}
          />
        </div>
